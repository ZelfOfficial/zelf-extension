...
@Component({
    ...
    selector: "welcome-zelfid-claim",
    styleUrls: ["./welcome-zelfid-claim.scss"],
    templateUrl: "./welcome-zelfid-claim.html",
})
export class WelcomeZelfidClaimComponent implements OnInit, OnDestroy, AfterContentInit {
    ...
    async searchZelfName(event: any): Promise<any> {
        ...
        this._zelfIdsService
            ...
            .then(async (response) => {
                ...
                this.planHint = this._zelfIdsService.resolvePlanHint(response.data, tagName);
    ...
    async goToImport(): Promise<void> {
        ...
        this._router.navigate(["/welcome-zelfid", "import"]);
    }
        ...
        this._zelfIdsService
            ...
            .then((response) => {
                ...
                if (referralTagModel) {
                    ...
                    this._zelfIdsService.setReferral(refName);
                } else {
                    this.referralTagModel = null;
                    this._setInvalidReferral();
                }
