...
export const DEFAULT_NETWORK_CONFIGS: NetworkConfig[] = [
    ...
    { id: "aptos", name: "Aptos", symbol: "APT", enabled: true },
 ...
 */
export const NETWORK_IDS_ENSURED_FROM_LICENSE_GAP: readonly string[] = ["stellar", "bitcoin", "sui", "ton", "aptos", "polkadot", "kusama"];
