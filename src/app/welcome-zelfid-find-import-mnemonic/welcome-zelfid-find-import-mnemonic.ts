...
@Component({
    ...
    selector: "welcome-zelfid-find-import-mnemonic",
    styleUrls: ["./welcome-zelfid-find-import-mnemonic.scss"],
    templateUrl: "./welcome-zelfid-find-import-mnemonic.html",
})
export class WelcomeZelfidFindImportMnemonicComponent implements OnInit {
    errorMessage: string = "";
    errorTitle: string = "";
    ...
    setMnemonics(): void {
        ...
        this._router.navigate(["/welcome-zelfid/find-import-claim"]);
    }
